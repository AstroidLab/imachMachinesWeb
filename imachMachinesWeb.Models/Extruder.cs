...
{
    public class Extruder : BaseClass
    {
        ...
        public int HeatingZones { get; set; }
        public string ScrewLength { get; set; }
        public string StdScrewAbility { get; set; }
        public string OptScrewAbility { get; set; }
        public string CrossHeadsMain { get; set; }
        public string CrossHeadsCo { get; set; }
        public string Output { get; set; }
        public string ScrewCenterDrilled { get; set; }
