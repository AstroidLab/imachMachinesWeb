...
{
    public class MockDoubleTwistBuncher
    {
        private List<DoubleTwistBuncher> _DoubleTwistBuncherList;

        public MockDoubleTwistBuncher()
        {
            _DoubleTwistBuncherList = new List<DoubleTwistBuncher>()
            {
                new DoubleTwistBuncher()
                {
        ...
        public IEnumerable<DoubleTwistBuncher> GetAllDoubleTwistBunchers()
        {
            return _DoubleTwistBuncherList;
        }
    }
}
