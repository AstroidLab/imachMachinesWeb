...
{
    public class MockRigidArmoring
    {
        private List<RigidArmoring> _RigidArmoringList;

        public MockRigidArmoring()
        {
            _RigidArmoringList = new List<RigidArmoring>()
            {
                new RigidArmoring()
                {
        ...
        public IEnumerable<RigidArmoring> GetAllRigidArmorings()
        {
            return _RigidArmoringList;
        }
    }
}
