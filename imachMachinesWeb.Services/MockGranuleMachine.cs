...
{
    public class MockGranuleMachine
    {
        private List<GranuleMachine> _GranuleMachineList;

        public MockGranuleMachine()
        {
            _GranuleMachineList = new List<GranuleMachine>()
            {
                new GranuleMachine()
                {
        ...
        public IEnumerable<GranuleMachine> GetAllGranuleMachines()
        {
            return _GranuleMachineList;
        }
    }
}
