...
{
    public class MockRigidStrander
    {
        private List<RigidStrander> _RigidStranderList;

        public MockRigidStrander()
        {
            _RigidStranderList = new List<RigidStrander>()
            {
                new RigidStrander()
                {
        ...
        public IEnumerable<RigidStrander> GetAllRigidStranders()
        {
            return _RigidStranderList;
        }
    }
}
