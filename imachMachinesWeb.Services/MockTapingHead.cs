...
{
    public class MockTapingHead
    {
        private List<TapingHead> _TapingHeadList;

        public MockTapingHead()
        {
            _TapingHeadList = new List<TapingHead>()
            {
                new TapingHead()
                {
        ...
        public IEnumerable<TapingHead> GetAllTapingHeads()
        {
            return _TapingHeadList;
        }
    }
}
