...
using System.Text;
using PowderingDevice = imachMachinesWeb.Models.PowderingDevice;

namespace imachMachinesWeb.Services
{
    public class MockPowderingDevice
    {
        private List<PowderingDevice> _PowderingDeviceList;

        public MockPowderingDevice()
        {
            _PowderingDeviceList = new List<PowderingDevice>()
            {
                new PowderingDevice()
                {
        ...
        public IEnumerable<PowderingDevice> GetAllPowderingDevices()
        {
            return _PowderingDeviceList;
        }
    }
}
