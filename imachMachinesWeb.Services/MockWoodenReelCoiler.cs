...
{
    public class MockWoodenReelCoiler
    {
        private List<WoodenReelCoiler> _WoodenReelCoilerList;

        public MockWoodenReelCoiler()
        {
            _WoodenReelCoilerList = new List<WoodenReelCoiler>()
            {
                new WoodenReelCoiler()
                {
        ...
        public IEnumerable<WoodenReelCoiler> GetAllWoodenReelCoilers()
        {
            return _WoodenReelCoilerList;
        }
    }
}
