...
{
    public class MockPortalTypePo
    {
        private List<PortalTypePo> _PortalTypePoList;

        public MockPortalTypePo()
        {
            _PortalTypePoList = new List<PortalTypePo>()
            {
                new PortalTypePo()
                {
        ...
        public IEnumerable<PortalTypePo> GetAllPortalTypePos()
        {
            return _PortalTypePoList;
        }
    }
}
