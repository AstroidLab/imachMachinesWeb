...
{
    public class MockMultiWirePo
    {
        private List<MultiWirePo> _MultiWirePoList;

        public MockMultiWirePo()
        {
            _MultiWirePoList = new List<MultiWirePo>()
            {
                new MultiWirePo()
                {
        ...
        public IEnumerable<MultiWirePo> GetAllMultiWirePos()
        {
            return _MultiWirePoList;
        }
    }
}
