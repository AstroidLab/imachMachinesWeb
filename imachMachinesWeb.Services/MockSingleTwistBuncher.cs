...
{
    public class MockSingleTwistBuncher
    {
        private List<SingleTwistBuncher> _SingleTwistBuncherList;

        public MockSingleTwistBuncher()
        {
            _SingleTwistBuncherList = new List<SingleTwistBuncher>()
            {
                new SingleTwistBuncher()
                {
        ...
        public IEnumerable<SingleTwistBuncher> GetAllSingleTwistBunchers()
        {
            return _SingleTwistBuncherList;
        }
    }
}
