...
{
    public class MockLengthMeasure
    {
        private List<LengthMeasure> _LengthMeasureList;

        public MockLengthMeasure()
        {
            _LengthMeasureList = new List<LengthMeasure>()
            {
                new LengthMeasure()
                {
        ...
        public IEnumerable<LengthMeasure> GetAllLengthMeasures()
        {
            return _LengthMeasureList;
        }
    }
}
