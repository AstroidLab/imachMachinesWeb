...
{
    public class MockSpoolerTu
    {
        private List<SpoolerTu> _SpoolerTuList;

        public MockSpoolerTu()
        {
            _SpoolerTuList = new List<SpoolerTu>()
            {
                new SpoolerTu()
                {
        ...
        public IEnumerable<SpoolerTu> GetAllSpoolerTus()
        {
            return _SpoolerTuList;
        }
    }
}
