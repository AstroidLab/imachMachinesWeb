...
{
    public class MockPlanetaryStrander
    {
        private List<PlanetaryStrander> _PlanetaryStranderList;

        public MockPlanetaryStrander()
        {
            _PlanetaryStranderList = new List<PlanetaryStrander>()
            {
                new PlanetaryStrander()
                {
        ...
        public IEnumerable<PlanetaryStrander> GetAllPlanetaryStranders()
        {
            return _PlanetaryStranderList;
        }
    }
}
