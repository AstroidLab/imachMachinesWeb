...
{
    public class MockPairingPo
    {
        private List<PairingPo> _PairingPoList;

        public MockPairingPo()
        {
            _PairingPoList = new List<PairingPo>()
            {
                new PairingPo()
                {
        ...
        public IEnumerable<PairingPo> GetAllPairingPos()
        {
            return _PairingPoList;
        }
    }
}
