...
{
    public class MockSkipStrander
    {
        private List<SkipStrander> _SkipStranderList;

        public MockSkipStrander()
        {
            _SkipStranderList = new List<SkipStrander>()
            {
                new SkipStrander()
                {
        ...
        public IEnumerable<SkipStrander> GetAllSkipStranders()
        {
            return _SkipStranderList;
        }
    }
}
