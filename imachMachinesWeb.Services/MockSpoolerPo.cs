...
{
    public class MockSpoolerPo
    {
        private List<SpoolerPo> _SpoolerPoList;

        public MockSpoolerPo()
        {
            _SpoolerPoList = new List<SpoolerPo>()
            {
                new SpoolerPo()
                {
        ...
        public IEnumerable<SpoolerPo> GetAllSpoolerPos()
        {
            return _SpoolerPoList;
        }
    }
}
