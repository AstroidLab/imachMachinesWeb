...
{
    public class MockRotatingPo
    {
        private List<RotatingPo> _RotatingPoList;

        public MockRotatingPo()
        {
            _RotatingPoList = new List<RotatingPo>()
            {
                new RotatingPo()
                {
        ...
        public IEnumerable<RotatingPo> GetAllRotatingPos()
        {
            return _RotatingPoList;
        }
    }
}
