...
{
    public class MockPortalTypeTu
    {
        private List<PortalTypeTu> _PortalTypeTuList;

        public MockPortalTypeTu()
        {
            _PortalTypeTuList = new List<PortalTypeTu>()
            {
                new PortalTypeTu()
                {
        ...
        public IEnumerable<PortalTypeTu> GetAllPortalTypeTus()
        {
            return _PortalTypeTuList;
        }
    }
}
