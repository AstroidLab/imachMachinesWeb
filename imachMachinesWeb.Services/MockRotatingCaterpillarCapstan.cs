...
{
    public class MockRotatingCaterpillarCapstan
    {
        private List<RotatingCaterpillarCapstan> _RotatingCaterpillarCapstanList;

        public MockRotatingCaterpillarCapstan()
        {
            _RotatingCaterpillarCapstanList = new List<RotatingCaterpillarCapstan>()
            {
                new RotatingCaterpillarCapstan()
                {
        ...
        public IEnumerable<RotatingCaterpillarCapstan> GetAllRotatingCaterpillarCapstans()
        {
            return _RotatingCaterpillarCapstanList;
        }
    }
}
