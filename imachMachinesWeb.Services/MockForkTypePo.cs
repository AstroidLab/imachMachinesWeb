...
{
    public class MockForkTypePo
    {
        private List<ForkTypePo> _ForkTypePoList;

        public MockForkTypePo()
        {
            _ForkTypePoList = new List<ForkTypePo>()
            {
                new ForkTypePo()
                {
        ...
        public IEnumerable<ForkTypePo> GetAllForkTypePos()
        {
            return _ForkTypePoList;
        }
    }
}
