...
{
    public class MockRotatingTu
    {
        private List<RotatingTu> _RotatingTuList;

        public MockRotatingTu()
        {
            _RotatingTuList = new List<RotatingTu>()
            {
                new RotatingTu()
                {
        ...
        public IEnumerable<RotatingTu> GetAllRotatingTus()
        {
            return _RotatingTuList;
        }
    }
}
