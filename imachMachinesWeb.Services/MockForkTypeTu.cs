...
{
    public class MockForkTypeTu
    {
        private List<ForkTypeTu> _ForkTypeTuList;

        public MockForkTypeTu()
        {
            _ForkTypeTuList = new List<ForkTypeTu>()
            {
                new ForkTypeTu()
                {
        ...
        public IEnumerable<ForkTypeTu> GetAllForkTypeTus()
        {
            return _ForkTypeTuList;
        }
    }
}
