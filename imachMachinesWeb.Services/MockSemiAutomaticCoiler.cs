...
{
    public class MockSemiAutomaticCoiler
    {
        private List<SemiAutomaticCoiler> _SemiAutomaticCoilerList;

        public MockSemiAutomaticCoiler()
        {
            _SemiAutomaticCoilerList = new List<SemiAutomaticCoiler>()
            {
                new SemiAutomaticCoiler()
                {
        ...
        public IEnumerable<SemiAutomaticCoiler> GetAllSemiAutomaticCoilers()
        {
            return _SemiAutomaticCoilerList;
        }
    }
}
